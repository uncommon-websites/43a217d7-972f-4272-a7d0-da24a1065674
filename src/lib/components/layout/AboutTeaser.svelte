...
<script lang="ts">
	...
	const teamMember: TeamMember = {
		...
		role: "Co-Founder",
		image: "/generated/image-a-professional-portrait-of-a-confident-f.webp"
	};
</script>
	...
	<div class="section-px section-py container mx-auto">
		<div class="relative mx-auto grid max-w-2xl place-items-center gap-16">
			<ScrollText
				...
				text={`"After watching my grandfather's wisdom become inaccessible following his stroke, I knew mentorship shouldn't be limited by time or physical presence. That pain became our purpose—democratizing access to expertise so no one has to face their challenges alone."`}
			/>
